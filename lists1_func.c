...
/**
 * ft_list_len - determines len of linked list
...
size_t ft_print_list(const list_t *h)
{
	...
	while (h)
	{
		_puts(ft_convert_number(h->num, 10, 0));
		_putchar(':');
		_putchar(' ');
...
/**
 * ft_node_starts - returns node whose string starts with prefix
 ...
 */
list_t *ft_node_starts(list_t *node, char *prefix, char c)
{
	char *p = NULL;
