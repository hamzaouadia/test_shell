...
/**
 * ft_ft_print_list_str - prints only the str element of a list_t linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
size_t ft_ft_print_list_str(const list_t *h)
{
	size_t i = 0;
...
/**
 * node_at_index - deletes node at given index
 * @head: address of pointer to first node
 * @index: index of node to delete
 *
 * Return: 1 on success, 0 on failure
 */
int node_at_index(list_t **head, unsigned int index)
{
